...
Google Fonts: Integração da fonte Oswald para uma identidade visual moderna.
...
Layout Adaptável: Uso de unidades de medida como vh (viewport height) e vw (viewport width) para garantir que o design preencha a tela.

Interatividade: Criação de feedbacks visuais com as pseudo-classes :hover e :active em botões e links de navegação.
